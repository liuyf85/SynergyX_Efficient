...
def main():
    ...
    if args.mode == 'train':
        ...
        for k in nfold:
            ...
            optimizer = torch.optim.Adam(model.parameters(),lr=args.lr, weight_decay=8e-5)
            ...
            for epoch in range(start_epoch, args.epochs):
                train_loss, lr_list = train(model=model,criterion=criterion,opt=optimizer,dataloader=tr_dataloader,device=device,scaler = scaler,args=args)
                # scheduler.step()
